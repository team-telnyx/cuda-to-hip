...
struct IVFFlatScan {
    static __device__ void scan(
        ...
        int laneId = hipThreadIdx_x % kWarpSize; // getLaneId();
...
#define RUN_IVF_FLAT                                                  \
    do {                                                              \
        hipLaunchKernelGGL(ivfFlatScan, grid, block,                  \
                codec.getSmemSize(dim), stream,                       \
                queries,                                              \
                useResidual,                                          \
                residualBase,                                         \
                listIds,                                              \
...
void runIVFFlatScan(
    ...
    constexpr idx_t kMaxQueryTileSize = 65536; // used as hipBlockIdx_y dimension
